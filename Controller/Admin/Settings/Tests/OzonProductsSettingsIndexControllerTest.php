 ...
 */
#[When(env: 'test')]
final class OzonProductsSettingsIndexControllerTest extends WebTestCase
{
    private const URL = '/admin/ozon/products/settings';

    private const ROLE = 'ROLE_OZON_PRODUCTS';
